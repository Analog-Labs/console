...
import { ANALOG_TIMECHAIN_GENESIS, CERE_NETWORK_GENESIS, CERE_NETWORK_TESTNET_GENESIS, DOCK_POS_TESTNET_GENESIS, JOYSTREAM_GENESIS, KUSAMA_GENESIS, NEATCOIN_GENESIS, NFTMART_GENESIS, POLKADOT_GENESIS, VARA_NETWORK_GENESIS, VARA_NETWORK_TESTNET_GENESIS } from '../constants.js';
...
const ANALOG_INFLATION_PARAMS = { ...DEFAULT_PARAMS, maxInflation: 0.04, minInflation: 0.01, stakeTarget: 0.6 };
...
const KNOWN_PARAMS: Record<string, InflationParams> = {
  ...
  [ANALOG_TIMECHAIN_GENESIS]: ANALOG_INFLATION_PARAMS
};
